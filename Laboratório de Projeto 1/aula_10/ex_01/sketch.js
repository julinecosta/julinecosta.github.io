...
function setup() 
{
  ...
  {
    circulos[i] = new CirculoEmbriagado (mouseX, mouseY, random(10, 30), 3);
  }
}
  ...
  for(var i=0; i<circulos.length; i++)
    {
      ...
      if (distancia <= circulos[i].diametro()/2) circulos[i].mudaCor(true);
      else circulos[i].mudaCor(false);
...
{ 
 ...
 mudaCor(preenche_)
  { 
    if (preenche_ === true) this.c = color(255, 0, 0);
